...
Source0  : https://cpan.metacpan.org/authors/id/S/SA/SALVA/Net-OpenSSH-0.83.tar.gz
...
%prep
%setup -q -n Net-OpenSSH-0.83
cd %{_builddir}
tar xf %{_sourcedir}/libnet-openssh-perl_0.78-1.debian.tar.xz
cd %{_builddir}/Net-OpenSSH-0.83
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Net-OpenSSH-0.83/deblicense/
